...
class AddPropertyControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val address = UkAddress("line 1", None, "town", None, "postcode")
  private val share = 1
  ...
  "AddProperty Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, addPropertyRoute)
