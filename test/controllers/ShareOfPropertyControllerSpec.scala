...
class ShareOfPropertyControllerSpec extends SpecBase with MockitoSugar {
  ...
  "ShareOfProperty Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, shareOfPropertyRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, shareOfPropertyRoute)
